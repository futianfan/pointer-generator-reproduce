...
Modification is based on 
	...
	https://github.com/becxer/pointer-generator/blob/master/decode.py

'''

"""This file contains code to run beam search decoding, including running ROUGE evaluation and producing JSON datafiles for the in-browser attention visualizer, 
...
if __name__ == '__main__':
	...
	beam_search_model = BeamSearchDecoder(model, None, None)
